...
<h1 class="text-center text-light">JUDUL VOTING</h1>
    <div class="container">
        <form class="row g-3 text-light" action="Proses/proses_booking.php" method="POST"> 
        <div class="col-md-6">
                <label for="inputEmail4" class="form-label">Nomor Urut</label>
                <input type="text" class="form-control" id="inputEmail4" name="tanggal">
            </div> 
            <div class="col-md-6">
                <label for="inputEmail4" class="form-label">Nama Kandidate</label>
                <input type="text" class="form-control" id="inputEmail4" name="tanggal">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
            <label for="formFile" class="form-label">Upload foto Kandidat</label>
            <input class="form-control" type="file" id="formFile">
            </div>
            <div class="col-md-6">
                <label for="inputEmail4" class="form-label">deskripsi kandidate</label>
                <input type="text" class="form-control" id="inputEmail4" name="tanggal">
            </div>
