...
<div class="col-lg-4 col-md-6">
                    <div class="text-white text-center mb-4 votcard shadow-md bg-white p-4 pt-5">
                        ...
                        <h4 class="mt-3 fs-5 mb-1 fw-bold">pemilihan president</h4>
                        <h6 class="fs-7">Runnung to Be: <span class="text-primary fw-bold">123press</span></h6>
                        ...
                        <button data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary fw-bolder fs-8">Lihat Hasil</button>
                        <button class="btn btn-danger fw-bolder px-4 ms-2 fs-8">Manage Voting</button>
                    </div>
                </div>
                 <div class="col-lg-4 col-md-6 ">
                    <div class="text-white text-center mb-4 votcard shadow-md bg-white p-4 pt-5">
                        <img class="rounded-pill shadow-md p-2" src="assets/images/testimonial/member-02.jpg" alt="">
                        <h4 class="mt-3 fs-5 mb-1 fw-bold">pemilihan osis</h4>
                        <h6 class="fs-7">Runnung to Be: <span class="text-primary fw-bold">123oss</span></h6>
                        <p class="text-dark mt-3 mb-3 fs-8">Aliquam utrum nibh rutrum nibh vitae tortor dapibus egestas. Cras condimentum dapibus tellus vel semper. Quisque vel dui molestie est auctor utrum nibh porttitor.</p>
                        <button data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary fw-bolder fs-8">Lihat hasil</button>
                        <button class="btn btn-danger fw-bolder px-4 ms-2 fs-8">Manage Voting</button>
                    </div>
